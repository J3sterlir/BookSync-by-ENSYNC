...
?>
    <nav id="sidebar">
            <ul>
                ...
                <li class="activehome">
                    <a href="home.php"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M240-200h120v-240h240v240h120v-360L480-740 240-560v360Zm-80 80v-480l320-240 320 240v480H520v-240h-80v240H160Zm320-350Z"/></svg>
                        <span>Home</span>
                    </a>
                </li>

                <li class="activeprofile">
                    <a href="Userprof.php">
                ...
                <li class="activereceipts">
                    <a href="receipt_info.php">
                ...
                <li>
                    <form action="Userprof.php" method="post" id="logoutform" class="formbutton">
